...
files_imf = ['imf_1_data_features_female_1.mat','imf_1_data_features_female_2.mat','imf_1_data_features_female_3.mat','imf_1_data_features_male_1.mat','imf_1_data_features_male_2.mat']
##Females
...
for f in range(5):
	...
	for base_clf in (SVC(kernel='linear'),LinearRegression(),LogisticRegression(),MultinomialNB()):
